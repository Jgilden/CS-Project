...
CREATE TABLE `dietary_restriction` (
  `dietary_restriction` varchar(45) NOT NULL,
  PRIMARY KEY (`dietary_restriction`)
...
INSERT INTO `dietary_restriction` VALUES ('NoRestriction'),('NutFree'),('Pescatarian'),('Vegan'),('Vegetarian');
